    ...
    <Container class="flex flex-wrap">
      <div class="flex items-center w-full lg:w-1/2">
        <div class="max-w-2xl mb-8">
          ...
          >
            Drink Your Beers Right With Beerly
          </h1>
          <p
    ...
    <Container>
      <div class="flex flex-col justify-center">
        <div class="text-xl text-center text-gray-700 dark:text-white">
          Trusted by <span class="text-indigo-600">2000+</span>customers
          worldwide
        </div>

        <div
          class="flex flex-wrap justify-center gap-5 mt-10 md:justify-around"
        >
